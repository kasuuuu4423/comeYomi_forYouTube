...
YT_API_KEY = 'AIzaSyCf32JHt-22WbyZsMwKkwiSbJa_vRlf67M'




def get_chat_id(yt_id):
    '''
    https://developers.google.com/youtube/v3/docs/videos/list?hl=ja
    '''
    video_id = yt_id #yt_url.replace('https://www.youtube.com/watch?v=', '')
